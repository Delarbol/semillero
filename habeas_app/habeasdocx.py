...
Una vez demostrado que la privación de la libertad personal o la \
prolongación de la privación de la libertad son el resultado de actos \
...
Del\u00A0señor\u00A0juez,\n\n''')
    ...
    p8.add_run(f'''{nom_solicitante}\t\t\n{id_solicitante}\u00A0{ced_solicitante}
Dirección\u00A0de\u00A0notificación\u00A0electrónica:\u00A0{email_solicitante}\t
